...
* In VRP - Outsourcing Fleet Model, essentially there are five organization types needed: ***Manufacturer; Distributor; Branch; Depot; Transporter***
* The hierarchy and functions of each organization is in the below table:
...
<Table align={["left","left","left"]}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Directly manages the dispatchers
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Directly manages the routing algorithms
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Directly manages the customers; products inventory; orders
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Transport products from the manufacturer warehouses to customers and vice versa\
        Directly manages the vehicles; drivers
      </td>
    </tr>
  </tbody>
</Table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        **Excel template:**\
        Input one of the following values into the cell to specify the organization type of the organization being created (Note: Input all letters in uppercase format): ***DISTRIBUTOR; BRANCH; DEPOT; TRANSPORTER***
      </td>
    </tr>
    ...
    <tr>
      <td>
        ...
        (Web form + Excel template)\
        (Required for organizations of Depot/Transporter type)
      </td>
    ...
    <tr>
      ...
      <td>
        **1. Description:**\
        The minimum and maximum time period (In minutes) the Depot being created requires each vehicle to load products\
        **2. Input rules:**\
        ...
        For example: The Depot being created requires each vehicle to load products no less than fifteen minutes and no more than thirty minutes. Input the following values into the Min Time and Max Time fields/cells respectively: 15; 30\
...
* You have two options to create organizations:
...
* The Manufacturer is the first organization you have to create. This organization can only be created using Web form
...
* Now the Manufacturer has been fully set up. You can move on to create other lower level organizations using either Web form or Excel template
