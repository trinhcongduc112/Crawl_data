...
* You will be navigated to the screen **Map view**. On this screen, a form will show up. On this form, you need to select the ***Branch*** and ***Date*** to generate Route Plan

<Image title="oOkhefbfaI.png" alt={396} className="border" border={true} src="https://files.readme.io/29fc399-oOkhefbfaI.png" />
...
<Image title="hiIaPJIsCw.png" alt={394} className="border" border={true} src="https://files.readme.io/3ab4627-hiIaPJIsCw.png" />
