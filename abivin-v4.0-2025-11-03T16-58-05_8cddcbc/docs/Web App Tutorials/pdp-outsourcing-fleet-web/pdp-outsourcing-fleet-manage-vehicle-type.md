...
next:
  description: ''
---
* In this model, you would have to create vehicle types before being able to create vehicles
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        **2. Input rules:**\
        ...
        For example: The vehicle type being created takes five minutes to load products with pallet. Input the following value into the field: 5
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        ...
        **2. Input rules:**\
        Input only the value in numbers. Do not input the unit\
        For example: The vehicle type being created takes five minutes to load products without pallet. Input the following value into the field: 5
      </td>
    </tr>
  </tbody>
</Table>
