...
* The Automatic Service Time is the default Service Time mechanism of Abivin vRoute system
...
* At the top of the algorithms section, you will see a phrase that says: ***Need\[ ] minutes for loading and unloading of packages weighting \[ ] kg***

<Image title="JHboxLAmca.png" alt={1458} className="border" border={true} src="https://files.readme.io/c505a47-JHboxLAmca.png" />

* If you tick the **Use Volume** checkbox, this phrase will change to ***Need\[ ] minutes for loading and unloading of packages volumn \[ ] m3***

<Image title="JvL8zVMqp3.png" alt={1454} className="border" border={true} src="https://files.readme.io/aea779b-JvL8zVMqp3.png" />

* This is where you can set up the Base Service Time. Input the suitable numbers into the two input fields

### Set up the Service Time Window at the Depot

> 📘 The Service Time Window can also be set up at the Sun and Crossdock
...
<Image title="pt0DjLjVzR.png" alt={1451} className="border" border={true} src="https://files.readme.io/a1ad451-pt0DjLjVzR.png" />
...
<Image title="KhO3JJ6q26.png" alt={513} className="border" border={true} src="https://files.readme.io/c222523-KhO3JJ6q26.png" />
...
<Image title="rVXvIK83A3.png" alt={941} className="border" border={true} src="https://files.readme.io/eaa63a3-rVXvIK83A3.png" />
...
<Image title="dQkukQK1xw.png" alt={313} className="border" border={true} src="https://files.readme.io/42c76b8-dQkukQK1xw.png" />
...
<Image title="uY88vzWRTl.png" alt={1487} className="border" border={true} src="https://files.readme.io/1cb9d61-uY88vzWRTl.png" />
