...
next:
  ...
  pages:
    - type: link
      ...
      url: https://docs.abivin.com/docs/vrp-in-house-fleet-manage-vehicles
---
...
* To know how the Drivers use the Mobile app to perform the delivery tasks, please refer to the following article: [**Drivers (Deliverymen)**](https://docs.abivin.com/docs/vrp-dc-mobile-app-driver)
...
* To know how to set up this type of User on the Web app, please refer to the following article: [**Salesmen**](https://docs.abivin.com/docs/vrp-in-house-fleet-salesmen-web)
* To know how the Salesmen use the Mobile app, please refer to the following article: [**Salesmen**](https://docs.abivin.com/docs/vrp-in-house-fleet-salesman-mobile)
...
* To know how to set up this type of User on the Web app, please refer to the following article: [**Consumers**](https://docs.abivin.com/docs/vrp-in-house-fleet-consumers)
* To know how the Consumers user the Consumer Mobile app to place Sales Order, please refer to the following article: [**Consumers**](https://docs.abivin.com/docs/vrp-in-house-fleet-consumers)
...
* When you use the Webform to create a single User, you need to input the [basic information fields](https://docs.abivin.com/docs/vrp-in-house-fleet-manage-users#basic-user-information) of that User in the following sequence to ensure no mistake:
* 1 - Organization Name
* 2 - Group
* 3 - Username
...
* 6 - Phone Number
* 7 - Full Name
* If the User being created is a Driver (Deliveryman), then apart from the basic information above, you also have to fill in some Driver-specific information fields. These information fields are described in the following section: [**Driver-specific information**](https://docs.abivin.com/docs/vrp-in-house-fleet-manage-users#driver-specific-information)
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        **2. Input rules:**\
        The password must comply with the rules outlined in the following article: [**User Account Setup**](https://docs.abivin.com/docs/web-app-account#section-password-rules)\
