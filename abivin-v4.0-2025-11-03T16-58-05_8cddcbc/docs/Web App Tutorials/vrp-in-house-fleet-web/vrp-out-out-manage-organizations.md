...
* In VRP model, essentially there are four organization types needed: ***Manufacturer; Distributor; Branch*** and ***Depot***
* Besides, there are other organization types, depends on your specific needs: ***Sun; Crossdock*** and ***Transporter***
...
<Table align={["left","left","left"]}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        The second level warehouse, only temporary stores products from the main Depot, before delivering to the customers\
        Directly manages the customers; products inventory; orders\
        Read more at this article: [**Optimize routes with Cross-docks**](https://docs.abivin.com/docs/cross-docking-management)
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Directly manages the outsourcing vehicle fleet
      </td>
    </tr>
  </tbody>
</Table>
...
> 📘 Apart from the information fields mentioned below, all other information fields can be left blank during the creation process
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        **Excel template:**\
        Input one of the following values into the cell to specify the organization type of the organization being created (Note: Input all letters in uppercase format): ***DISTRIBUTOR; BRANCH; DEPOT; SUN; CROSSDOCK; TRANSPORTER***
      </td>
    </tr>
