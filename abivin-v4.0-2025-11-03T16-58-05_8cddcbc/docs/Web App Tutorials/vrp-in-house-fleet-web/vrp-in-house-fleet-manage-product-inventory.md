...
next:
  description: ''
---
> 🚧 At the moment, this feature only works for VRP - Transporters to Create Routes Model
...
* Apart from the general information fields of the products (which have been input during the creation process), in **Products > Inventory** tab, there are some other information fields which reflect the changes in inventory of the products

> 🚧 At the moment, the system only tracks the changes in whole case quantity, not single items quantity of the products
...
<Table align={["left","left"]}>
  ...
  <tbody>
    <tr>
      ...
      <td>
        The quantity of whole cases of a specific product (Finished products)  physically available on your organization warehouse shelves
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        The aggregate quantity of whole cases of a specific product (Finished products) which have actually been picked out of your organization's warehouse shelves and put on to the delivery vehicles, about to be delivered to other locations (Partner or Customer warehouses)
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        ...
        The aggregate quantity of whole cases of a specific product (Finished products) recorded from all ongoing Sales Orders\
        This is the quantity originally planned to be delivered to the customerss
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        The aggregate quantity of whole cases of a specific product (Empty product cases or Returned products - products that the partners refused to receive) that have actually been picked up from the customers and are being carried by the delivery vehicles back to your manufacturing warehouses
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        ...
        The aggregate quantity of whole cases of a specific product (Empty product cases or Returned products - products that the partners refused to receive) recorded from all ongoing Pickup Orders\
        This is the quantity originally planned to be picked up from the customers
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        ...
        The aggregate quantity of whole cases of a specific product (Materials or other finished products that you organization purchases from the Suppliers) recorded from all ongoing Purchase Orders\
        This is the quantity originally planned to be purchased from the suppliers
      </td>
    </tr>
  </tbody>
</Table>
