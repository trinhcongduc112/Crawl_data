...
next:
  description: ''
---
* In this model, essentially there are two types of Users
* **Administrators:** Users who will manage the Web app
* **Drivers:** Users who will directly perform deliveries using Mobile app
* Users will be allocated into User groups. Each User group is assigned with different rights and roles
...
* If you created the **Depot** organization using Web form, the Driver User group - with the User group code ***DELIVERER*** would also be created automatically

- If you created the **Depot** organization using Excel template, the Driver User group would not be created automatically. You will have to create that User group manually
...
<Image title="l0H5WT9uBs.png" alt={816} className="border" border={true} src="https://files.readme.io/914b596-l0H5WT9uBs.png" />

* If your operation involves using  services by Products**], enable the, enable the **Services** module as below

<Image title="yMEFXCdkuS.png" alt={816} className="border" border={true} src="https://files.readme.io/414fccd-yMEFXCdkuS.png" />

* If your operation involves using nd Promotions**], enable the *, enable the **Promotion** module as below

<Image title="Uvq4XX2Pms.png" alt={816} className="border" border={true} src="https://files.readme.io/6d7d579-Uvq4XX2Pms.png" />

#### Driver User group

<Image title="HiTH56ImNx.png" alt={822} className="border" border={true} src="https://files.readme.io/89ae88b-HiTH56ImNx.png" />
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        **Excel template:**\
        **VRP model:**\
        Input only one value from the following three values into the cell (Note:The value must always be input in English): truck; bike; semi-truck
      </td>
    </tr>
