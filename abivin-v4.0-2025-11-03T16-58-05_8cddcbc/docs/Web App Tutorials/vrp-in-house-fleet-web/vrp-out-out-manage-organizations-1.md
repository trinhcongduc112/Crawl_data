...
* In VRP - Out-Out model, essentially there are three organization types needed: ***Manufacturer; Depot*** and ***Transporter***
...
<Table align={["left","left","left"]}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Directly manages the outsourcing vehicle fleet (Vehicles; drivers)
      </td>
    </tr>
  </tbody>
</Table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        **Excel template:**\
        Input only one of the following two values into the cell to specify the organization type of the organization being created (Note: Input all letters in uppercase format): ***DEPOT; TRANSPORTER***
      </td>
    </tr>
