---
title: Delivery Progress Tracking (Clone for RnD - VRP)
excerpt: ''
deprecated: false
hidden: true
metadata:
...
* The Execution Timeline serves as a tracking timeline, where you can view the actual delivery progress of the vehicles in real-time
* To access the Execution Timeline, click on the switch button  :fa-toggle-off: next to the text **Plan** on the Timeline panel

<Image title="11. EXE (ENG).png" alt={1734} border={true} src="https://files.readme.io/3ec1a84-11._EXE_ENG.png">
  Illustration (English)
</Image>

<Image title="5. EXE (VIE).png" alt={1733} border={true} src="https://files.readme.io/abf3713-5._EXE_VIE.png">
  Illustration (Vietnamese)
</Image>

## The Route Plan Screen (Execution)

* The Route Plan screen (Execution) is divided into two sections: 
* 1 - The Route Map 
...
![248](https://files.readme.io/2e307fc-Red_1.png "Red 1.png")

* The line of the small route segment will be in Green color when the Vehicle's speed is greater than or equal to 30 km/h

![245](https://files.readme.io/83d097b-Green_1.png "Green 1.png")

* When you hover the mouse onto the Depot icon, the name of the Depot will show up. When you click the icon, you will be directed to the side panel showing [Depot Details in Execution](https://docs.abivin.com/docs/delivery-progress-tracking-vrp-dc-model#view-depot-details-in-execution-delivery-timeline)

<Image title="21. DEPOT (EXE).png" alt={131} className="border" border={true} src="https://files.readme.io/2379c48-21._DEPOT_EXE.png" />

* When you hover the mouse onto the Stop icon on the Route Map Screen, the name of the Stop will show up. The 
...
* 2 - View Shift Details in Execution Delivery Timeline 

* 3 - View Stop Details in Execution Delivery Timeline

* 4 - Replay actual delivery routes
...
## View Depot Details in Execution Delivery Timeline
...
<Image title="13. Stop EXE (ENG).png" alt={516} border={true} src="https://files.readme.io/8320df9-13._Stop_EXE_ENG.png">
  Illustration (English)
</Image>

<Image title="13. Stop EXE (VIE).png" alt={515} border={true} src="https://files.readme.io/16a6868-13._Stop_EXE_VIE.png">
  Illustration (Vietnamese)
</Image>

* A form with the title in the format **Customer\<Customer Code>** will show up on the right corner of the screen. The form will comprise of these parts
* 1 - Customer Name
* 2 - The Status of the Orders
* 3 - The Check-In photos taken by the Drivers when they actually reached the selected Stop

<Image title="5. Photo (ENG).png" alt={515} border={true} src="https://files.readme.io/c2263d6-5._Photo_ENG.png">
  Illustration (English)
</Image>

<Image title="5. Photo (VIE).png" alt={516} src="https://files.readme.io/ff9979f-5._Photo_VIE.png">
  Illustration (Vietnamese)
</Image>

* Here is the list of the information fields in the table below
...
* The other fields in the form providing details about the Stop are exactly the same as those in the form in \*Plan\*\* Delivery Timeline. Please click here for more information [Stop Details](https://docs.abivin.com/docs/route-plan-map-view-clone#view-stop-details)
