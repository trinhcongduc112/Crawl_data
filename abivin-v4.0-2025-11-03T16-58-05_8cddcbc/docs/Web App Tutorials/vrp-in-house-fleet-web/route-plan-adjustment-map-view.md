---
title: Route Plan Adjustment (Map View) (For RnD)
excerpt: ''
deprecated: false
hidden: true
metadata:
...
## Re-optimize Route Plan

* Before re-optimizing a Route Plan, make sure that you have ticked the **Optimize** checkbox for your User Group (in **OTHER PERMISSIONS** tab when you edit the user group)\
  \##Scenario 1: Route Plan with no Locked or Finalized Route
* If there is no locked or finalized route, after clicking the **Optimize** button, you will see a pop-up window confirming the Branch and Date for route optimization

## Scenario 2: Route Plan with at least one Locked or Finalized Route

* In this case, when you click the **Optimize** button, a window will pop up with the **Cut-off Time** field. The valid input values range from 1:00 to 23:00 with intervals of 30 minutes (Example: 1:00; 1:30; 2:00)

- The optimization result varies depending on the following cases:
- 1 - The new Shift is delivered by a new vehicle: 
- If the Cut-off Time is not chosen or it is before the Start Time of the vehicle, the Shift Start Time will be equal to the Start Time of the vehicle or the Start Time of the Depot
- If the Cut-off Time is similar to or later than the Start Time of the vehicle, the Shift Start Time will be equal to the chosen Cut-off Time
- 2 - The new Shift is delivered by a vehicle that has already delivered at least one Shift:
- If the Cut-off Time is not chosen or it is before the Start Time of the vehicle, the Start Time of the next Shift will be equal to the Close Time of the previous Shift PLUS 30 minutes
- If the Cut-off Time is later than the Start Time of the vehicle, the Start Time of the next Shift will be equal to the chosen Cut-off Time
...
> 📘 If after removing a customer, you don't click on **Lock Route** button but instead click on **Optimize** button, that customer will be moved back to the Delivery shift
...
> 🚧 In order to be able to use this function, you need to enable the configuration **Enable Unlock Route** at the **Branch**
...
> 🚧 In order to be able to use this function, you need to enable the configuration **Allow Unlock One VRP route** at the **Branch**
...
> ❗️ Be cautious when using this function!
>
...
> 📘 To change Delivery Shift's vehicle in the Route Plan (List View), refer to this article: [**Route Plan (List View)**]()
...
<Image title="2021-03-10_10-23-00.png" alt={2878} border={true} src="https://files.readme.io/e888222-2021-03-10_10-23-00.png">
  Illustration Image (English)
</Image>

<Image title="2021-03-10_11-11-01.png" alt={2878} src="https://files.readme.io/d0951cc-2021-03-10_11-11-01.png">
