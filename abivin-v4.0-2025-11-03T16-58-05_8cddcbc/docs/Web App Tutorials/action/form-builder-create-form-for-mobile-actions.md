---
title: Form Builder - Create form for PDP model
excerpt: ''
deprecated: false
hidden: true
metadata:
...
next:
  description: ''
---
## General steps to create form for an action
...
* You can use multiple components to build the form of an action. There are several components such as **Panel**, **Table** (Under **Layout Components** section) or **Container** (Under **Special Components** section) that allows you to click and drag other components ***inside*** them. Điều này sẽ được mô tả thực tế ở bên dưới
...
* **Step 5**. Scroll down to the end of the setup screen, click on the green **Save view** to finish setting up the form for the action

> ❗️ This step is very important! You must not forget to do this, or else you will lose every configurations you have just setup
