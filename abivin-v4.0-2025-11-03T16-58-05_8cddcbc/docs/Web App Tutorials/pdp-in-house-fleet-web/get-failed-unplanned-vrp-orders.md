---
title: Get Failed/Unplanned Orders
excerpt: ''
deprecated: false
hidden: true
metadata:
...
next:
  description: ''
---
## Enable Allow Re-delivery Order configuration

* Navigate to **Organizations > Organization List** tab
* Click on **Edit** :fa-pencil: icon of the top organization - The ***Manufacturer***

- On the **Organization Information** screen, click on **Allow Re-delivery Order** check box
- Click **Save** to confirm the change

## Get Failed Orders

* Navigate to 
* Hover over, then click on **Fetch old order** :fa-refresh: icon
