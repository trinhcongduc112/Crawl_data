...
* This tab lists all the organizations in which you belong or have the management rights over, if you are the administrator user
...
<Table align={["left","left","left"]}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Directly manages the truck tractors, trailers, containers, drivers and customers
      </td>
    </tr>
  </tbody>
</Table>
